...
This module is intended to be removed immediately after the recovery succeeds.
It only updates the fixed `admin` account and never exposes password hashes.
"""
